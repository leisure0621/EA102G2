...
public class RepairMainJNDIDAO implements I_RepairMainDAO {
	...
	private static final String INSERT_STMT = "INSERT INTO repair_main (repair_id, mem_id, cat_id, pro_name, description, status_id, amount, dev_address, recipient, pay_via, delivery)"
			+ "VALUES ('RO'||LPAD(SEQ_REPAIR_ID.NEXTVAL, 4, '0'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = "SELECT repair_id, mem_id, cat_id, pro_name, description, status_id, est_time, amount, dev_address, recipient, pay_via, delivery FROM repair_main order by repair_id";
	private static final String GET_ONE_STMT = "SELECT repair_id, mem_id, cat_id, pro_name, description, status_id, est_time, amount, dev_address, recipient, pay_via, delivery FROM repair_main WHERE repair_id = ?";
	private static final String DELETE = "DELETE FROM repair_main where repair_id = ?";
	private static final String UPDATE = "UPDATE repair_main set mem_id=?, cat_id=?, pro_name=?, description=?, status_id=?, amount=?, dev_address=?, recipient=?, pay_via=?, delivery=?"
			+ "where repair_id = ?";
	private static final String GET_BY_MEM = "SELECT repair_id, mem_id, cat_id, pro_name, description, status_id, est_time, amount, dev_address, recipient, pay_via, delivery FROM repair_main WHERE mem_id = ? order by est_time";
	...
	public static void main(String[] args) {
		...
		RepairMainJNDIDAO dao = new RepairMainJNDIDAO();
...
//		rmVO2.setAmount(3500.0);
//		rmVO2.setDev_address("新竹市香山區富農一街800巷26弄858號");
//		rmVO2.setRecipient("霍建");
//		rmVO2.setPay_via(2.0);
//		rmVO2.setDelivery(3.0);
//		rmVO2.setRepair_id("RO0006");
//		dao.update(rmVO2);
