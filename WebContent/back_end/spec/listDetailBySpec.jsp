...
<title>List All Details of Specification</title>
							...
							<div class="modal-body">
								<div class="form-horizontal">
									<div class="form-group">
										<table class="table">
											<tr>
												<th><b style="color: blue">【${catVO.cat_id}】${catVO.cat_des}</b>中關於
													<b style="color: blue">${specVO.spec_des}</b> 的所有規格細節</th>

											</tr>
											<c:forEach var="specD" items="${specDetails}">
												<tr>
													<th>${specD.detail_des}</th>
												</tr>
											</c:forEach>
										</table>
										...
										<form method="post"
											...
											<input type="hidden" name="action" value="getSpecMainToAdd">
											<input type="hidden" name="spec_id" value="${specVO.spec_id}">
											<input type="submit" value="新增規格細節">
										</form>
									</div>
								</div>
							</div>
